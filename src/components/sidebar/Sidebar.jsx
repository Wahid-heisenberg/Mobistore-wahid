            ...
            { NavlinksArray.map(item => (
             ...
             <Link 
              to={`/${item.title}`}
                  ...
                  className={activeItem === item.title ? 'active LinkContainer Link' : 'LinkContainer Link'}
                     >      
...
{!showDialog &&       
      <Link
                 key='55'
                  ...
                  className={activeItem === 'Déconnexion'? 'active LinkContainer Link' : 'LinkContainer Link'}
                     >        
                <IconContainer >
